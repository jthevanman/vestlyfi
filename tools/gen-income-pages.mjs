...
const BANDS = {
  ...
  entry: {
    intro: S => [
      ...
      `This is the income band where most first-time buyers live, and the playbook is well-worn: FHA with 3.5% down if savings are thin, conventional with 5–10% down if your credit is 680+, and a hard look at existing debts before you shop, because at this income they can eat directly into the price you can pay.`,
    ],
